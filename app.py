...
async def MaiiiinE():
    ...
    # BOT LOGIN UID
    BOT_UID = int('14332839144')  # <-- FIXED BOT UID

    Uid, Pw = '4384969517', '7F1A85F0B19EF00DCCE2AB848DB31785885E1935D9AAF3B47D491AF8B37C89E1'
